// Engine nhận diện giọng nói DUY NHẤT của app: Whisper (base.en) chạy hoàn toàn client-side
// qua @huggingface/transformers, model tự host trong public/models/ (xem src/lib/whisperSpeech.js).
